...
},a.prototype.stop=function(){this._isSetTimeOut?clearTimeout(this._timeOutID):window.cancelAnimationFrame(this._rafId),this.isRunning=!1},a.prototype.RAFUpdate=function(){var a=this;this.currentTime=Date.now(),this._callback&&this._callback();var b=Math.max(0,16-(this.currentTime-this.lastTime));this._rafId=window.requestAnimationFrame(function(){return a.RAFUpdate()}),this.lastTime=this.currentTime+b},a.prototype.SetTimeoutUpdate=function(){var a=this;this.currentTime=Date.now(),this._callback&&this._callback();var b=Math.max(0,16-(this.currentTime-this.lastTime));this._timeOutID=window.setTimeout(function(){return a.SetTimeoutUpdate()},b),this.lastTime=this.currentTime+b},a}();a.RequestAnimationFrame=b}(b=a.Utils||(a.Utils={}))}(Kiwi||(Kiwi={}));var Kiwi;!function(a){var b;!function(b){var c=function(){function b(a){void 0===a&&(a={}),this.enabled=!0,this.recording=!0,this.display=!0,this.tagFilters=[],this.maxRecordings=1/0,this.recordings=[],this.setDefaultsFromParams(a)}return b.prototype.setDefaultsFromParams=function(b){void 0===b&&(b={}),a.Utils.Common.isUndefined(b.enabled)||(this.enabled=b.enabled),a.Utils.Common.isUndefined(b.recording)||(this.recording=b.recording),a.Utils.Common.isUndefined(b.display)||(this.display=b.display),a.Utils.Common.isUndefined(b.maxRecordings)||(this.maxRecordings=b.maxRecordings),a.Utils.Common.isArray(b.tagFilters)&&(this.tagFilters=b.tagFilters)},Object.defineProperty(b.prototype,"lastMessageTime",{get:function(){return this.recordings.length>0?this.recordings[this.recordings.length-1].time:0},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"numRecordings",{get:function(){return this.recordings.length},enumerable:!0,configurable:!0}),b.prototype.record=function(a,b,c){if(void 0===b&&(b=[]),void 0===c&&(c=console.log),this.recording){var d={messages:a,time:Date.now(),tags:b,logMethod:c};this.recordings.push(d)>this.maxRecordings&&this.recordings.shift()}},b.prototype.clearRecordings=function(a,b){void 0===a&&(a=0),void 0===b&&(b=this.recordings.length),this.recordings.splice(a,b)},b.prototype._execute=function(a,b,c,d){void 0===d&&(d=!1),(this.display||d)&&a.apply(b,c)},b.prototype.getTagsFromArray=function(a){for(var b=0,c=[];b<a.length;)"string"==typeof a[b]&&"#"===a[b].charAt(0)&&c.push(a[b]),b++;return c},b.prototype._filterTags=function(a,b){if(void 0===b&&(b=this.tagFilters),0===b.length)return!0;if(0==a.length)return!1;for(var c=0;c<a.length;){if(-1===b.indexOf(a[c]))return!1;c++}return!0},b.prototype.log=function(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];if(this.enabled){var c=this.getTagsFromArray(a);this.record(a,c,console.log),this._filterTags(c)&&this._execute(console.log,console,a)}},b.prototype.warn=function(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];if(this.enabled){var c=this.getTagsFromArray(a);this.record(a,c,console.warn),this._filterTags(c)&&this._execute(console.warn,console,a)}},b.prototype.error=function(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];if(this.enabled){var c=this.getTagsFromArray(a);this.record(a,c,console.error),this._filterTags(c)&&this._execute(console.error,console,a)}},b.prototype._show=function(a,b){if(!a.logMethod)return!1;for(var c=b.length;c--;)if(-1==a.tags.indexOf(b[c]))return!1;return this._execute(a.logMethod,console,a.messages,!0),!0},b.prototype.showLast=function(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];for(var c=this.recordings.length;c--;)if(this._show(this.recordings[c],a))return},b.prototype.showAll=function(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];for(var c=0;c<this.recordings.length;c++)this._show(this.recordings[c],a)},b.prototype.showLogs=function(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];for(var c=0;c<this.recordings.length;c++)this.recordings[c].logMethod===console.log&&this._show(this.recordings[c],a)},b.prototype.showErrors=function(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];for(var c=0;c<this.recordings.length;c++)this.recordings[c].logMethod===console.error&&this._show(this.recordings[c],a)},b.prototype.showWarnings=function(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];for(var c=0;c<this.recordings.length;c++)this.recordings[c].logMethod===console.warn&&this._show(this.recordings[c],a)},b.prototype.showTimePeriod=function(a,b,c){void 0===a&&(a=0),void 0===b&&(b=1/0),void 0===c&&(c=[]);for(var d,e=0;e<this.recordings.length;e++)d=this.recordings[e],a<d.time&&b>d.time&&this._show(d,c)},b.prototype.addFilter=function(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];this.tagFilters=this.tagFilters.concat(a)},b.prototype.removeFilter=function(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];for(var c,d=0;d<a.length;)c=this.tagFilters.indexOf(a[d]),-1!==c&&this.tagFilters.splice(c,1),d++},b}();b.Log=c}(b=a.Utils||(a.Utils={}))}(Kiwi||(Kiwi={}));var Kiwi;!function(a){var b;!function(a){var b=function(){function a(){}return a.parseVersion=function(a){var b=a.split(".");return{majorVersion:parseInt(b[0]),minorVersion:parseInt(b[1]),patchVersion:parseInt(b[2])}},a.compareVersions=function(b,c){var d=a.parseVersion(b),e=a.parseVersion(c);return d.majorVersion>e.majorVersion?"greater":d.majorVersion<e.majorVersion?"less":d.minorVersion>e.minorVersion?"greater":d.minorVersion<e.minorVersion?"less":d.patchVersion>e.patchVersion?"greater":d.patchVersion<e.patchVersion?"less":"equal"},a.greaterOrEqual=function(b,c){var d=a.compareVersions(b,c);return"greater"==d||"equal"==d},a}();a.Version=b}(b=a.Utils||(a.Utils={}))}(Kiwi||(Kiwi={}));var Kiwi;!function(a){a.Log=new a.Utils.Log,a.VERSION="1.4.0-M",a.RENDERER_CANVAS=0,a.RENDERER_WEBGL=1,a.RENDERER_AUTO=2,a.TARGET_BROWSER=0,a.TARGET_COCOON=1,a.DEBUG_ON=0,a.DEBUG_OFF=1,a.DEVICE=null,a.STATE=0,a.GROUP=2,a.ENTITY=3,a.CAMERA=4,a.HUD_WIDGET=5,a.TILE_LAYER=6;var b=function(){function b(){}return b.prototype.objType=function(){return"GameManager"},b.register=function(b){return a.GameManager._games.push(b)},b.total=function(){return a.GameManager._games.length},b._games=[],b}();a.GameManager=b;var c;!function(a){}(c=a.Plugins||(a.Plugins={})),a.extend=function(a,b){function c(){this.constructor=a}for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d]);c.prototype=b.prototype,a.prototype=new c}}(Kiwi||(Kiwi={}));var Kiwi;!function(a){var b;!function(b){var c=function(b){function c(c,d,e,f,g){void 0===d&&(d=0),void 0===e&&(e=0),void 0===f&&(f=0),void 0===g&&(g=0),b.call(this,c,"Box2"),this._offset=new a.Geom.Point(d,e),this._dimensions=new a.Geom.Point(f,g),this._dirty=!0}return __extends(c,b),c.prototype.objType=function(){return"Box2"},Object.defineProperty(c.prototype,"offset",{get:function(){return this._offset},enumerable:!0,configurable:!0}),Object.defineProperty(c.prototype,"dimensions",{get:function(){return this._dimensions},enumerable:!0,configurable:!0}),Object.defineProperty(c.prototype,"hitbox",{set:function(a){throw"Not yet implemented"},enumerable:!0,configurable:!0}),c.prototype.clean=function(){this._invertedTransformMatrix=this.owner.transform.getConcatenatedMatrix().clone(),this._invertedTransformMatrix.tx-=this.owner.transform.rotPointX,this._invertedTransformMatrix.ty-=this.owner.transform.rotPointY,this._invertedTransformMatrix.invert()},c.prototype.check=function(a){this._dirty&&this.clean();var b=this._invertedTransformMatrix.transformPoint(a);return b.x>this._offset.x&&b.x<this._dimensions.x&&b.y>this._offset.y&&b.y<this._dimensions.y},c.prototype.draw=function(a,b){throw void 0===b&&(b=this.game.cameras.defaultCamera),"Not yet implemented"},c.prototype.destroy=function(){b.prototype.destroy.call(this)},c}(a.Component);b.Box2=c}(b=a.Components||(a.Components={}))}(Kiwi||(Kiwi={}));var Kiwi;!function(a){var b;!function(b){var c=function(b){function c(c,d){void 0===d&&(d={}),b.call(this,c,d),this.crossOrigin="",this.game.audio.usingAudioTag?(this.useTagLoader=!0,this._loadInParallel=!0):this.useTagLoader=!1,a.Utils.Common.isUndefined(d.crossOrigin)||(this.crossOrigin=d.crossOrigin)}return __extends(c,b),c.prototype.objType=function(){return"AudioFile"},c.prototype._load=function(){this.attemptCounter++,this.useTagLoader?this.tagLoader():this.xhrLoader("GET","arraybuffer")},c.prototype.tagLoader=function(){if(this.data=document.createElement("audio"),this.data.src=this.URL,this.data.preload="auto",this.crossOrigin&&(this.data.crossOrigin=this.crossOrigin),this.game.audio.locked)this.loadSuccess();else{var b=this,c=function(a){b.data.removeEventListener("canplaythrough",c,!1),b.data.pause(),b.data.currentTime=0,b.data.volume=1,b.loadSuccess()};this.data.addEventListener("canplaythrough",c,!1),this.game.deviceTargetOption==a.TARGET_COCOON?this.data.load():(this.data.volume=0,this.data.play())}},c.prototype.processXhr=function(a){this.data={raw:a,decoded:!1,buffer:null},this._decodeAudio()},c.prototype._decodeAudio=function(){var b=this;if(!b.processed){b.processed=!0;var c=function(c){a.Log.error("Kiwi.Files.AudioFile: Error decoding audio data.","#loading","#decoding",c),b.loadError(c)},d=function(a){a&&(b.data.buffer=a,b.data.decoded=!0,b.loadSuccess())},e=this.game.audio.context.decodeAudioData(this.data.raw,d,c);Promise&&e instanceof Promise&&e.then(d)}},c}(a.Files.File);b.AudioFile=c}(b=a.Files||(a.Files={}))}(Kiwi||(Kiwi={}));var Kiwi;!function(a){var b;!function(b){var c=function(b){function c(a,c){void 0===c&&(c={}),b.call(this,a,c),this.useTagLoader=!1,this._loadInParallel=!1}return __extends(c,b),c.prototype.parseParams=function(c){b.prototype.parseParams.call(this,c),a.Utils.Common.isUndefined(c.parse)?this.parse=!1:this.parse=c.parse},c.prototype.objType=function(){return"DataFile"},c.prototype._load=function(){this.attemptCounter++,this.dataType===a.Files.File.BINARY_DATA?this.xhrLoader("GET","arraybuffer"):this.xhrLoader("GET","text")},c.prototype.processXhr=function(b){if(!this.parse)return this.data=b,void this.loadSuccess();switch(this.dataType){case a.Files.File.JSON:this.processJSON(b);break;case a.Files.File.XML:this.parseXML(b);break;case a.Files.File.TEXT_DATA:case a.Files.File.BINARY_DATA:default:this.data=b}},c.prototype.parseXML=function(b){if(a.Log.log("Kiwi.Files.DataFile: Data loaded is being parsed as XML.","#loading","#parsing"),window.DOMParser){var c=new DOMParser;this.data=c.parseFromString(b,"text/xml")}else this.data=new ActiveXObject("Microsoft.XMLDOM"),this.data.async="false",this.data.loadXML(b);this.data&&this.data.documentElement&&!this.data.getElementsByTagName("parsererror").length?this.loadSuccess():this.loadError("XML parse error.")},c.prototype.processJSON=function(b){a.Log.log("Kiwi.Files.DataFile: Data loaded is being parsed as JSON.","#loading","#parsing");try{this.data=JSON.parse(b)}catch(c){return void this.loadError(c)}this.loadSuccess()},c}(a.Files.File);b.DataFile=c}(b=a.Files||(a.Files={}))}(Kiwi||(Kiwi={}));var Kiwi;!function(a){var b;!function(b){var c=function(b){function c(c,d){void 0===d&&(d={}),b.call(this,c,d),this.crossOrigin="",d.xhrLoading?(this.useTagLoader=!1,this._loadInParallel=!1):(this.useTagLoader=!0,this._loadInParallel=!0),a.Utils.Common.isUndefined(d.crossOrigin)||(this.crossOrigin=d.crossOrigin)}return __extends(c,b),c.prototype.objType=function(){return"TextureFile"},c.prototype._load=function(){this.attemptCounter++,this.useTagLoader?this.tagLoader():this.xhrLoader("GET","arraybuffer")},c.prototype.tagLoader=function(){var a=this;this.data=new Image,this.data.src=this.URL,this.crossOrigin&&(this.data.crossOrigin=this.crossOrigin),this.data.onload=function(){return a.loadSuccess()},this.data.onerror=function(b){return a.loadError(b)}},c.prototype.processXhr=function(a){this.data=document.createElement("img");var b=new Blob([a],{type:this.type}),c=this;this.data.addEventListener("load",function(a){c.loadSuccess()}),window.URL?this.data.src=window.URL.createObjectURL(b):window.webkitURL&&(this.data.src=window.webkitURL.createObjectURL(b))},c.prototype.revoke=function(){window.URL?window.URL.revokeObjectURL(this.data.src):window.webkitURL&&window.webkitURL.revokeObjectURL(this.data.src)},c.prototype.destroy=function(){this.useTagLoader||this.revoke(),b.prototype.destroy.call(this)},c}(a.Files.File);b.TextureFile=c}(b=a.Files||(a.Files={}))}(Kiwi||(Kiwi={}));var Kiwi;!function(a){var b;!function(b){var c;!function(b){var c=function(b){function c(){b.apply(this,arguments)}return __extends(c,b),c.prototype.objType=function(){return"TileMapObjectLayer"},c.prototype.getTileFromXY=function(a,b){var c=this.getIndexFromXY(a,b);return-1!==c?this.tilemap.tileTypes[this._data[c]?this._data[c].tileType:0]:null},c.prototype.countTiles=function(a){for(var b=0,c=0;c<this._data.length;c++)void 0==a&&0!==this._data[c].tileType?b++:a===this._data[c].tileType&&b++;return b},c.prototype.getIndexesByType=function(a){for(var b=[],c=0;c<this._data.length;c++)this._data[c].tileType==a&&b.push(c);return b},c.prototype.getTileFromIndex=function(a){return-1!==a?this.tilemap.tileTypes[this._data[a].tileType]:null},c.prototype.getTileFromCoords=function(a,b){var c=this.getIndexFromCoords(a,b);return-1!==c?this.tilemap.tileTypes[this._data[c].tileType]:null},c.prototype.randomizeTiles=function(b,c,d,e,f){void 0===c&&(c=0),void 0===d&&(d=0),void 0===e&&(e=this.width),void 0===f&&(f=this.height),a.Log.log("Not implemented.","#tilemap")},c.prototype.replaceTiles=function(b,c,d,e,f,g){void 0===d&&(d=0),void 0===e&&(e=0),void 0===f&&(f=this.width),void 0===g&&(g=this.height),a.Log.log("Not implemented.","#tilemap")},c.prototype.swapTiles=function(b,c,d,e,f,g){void 0===d&&(d=0),void 0===e&&(e=0),void 0===f&&(f=this.width),void 0===g&&(g=this.height),a.Log.log("Not implemented.","#tilemap")},c}(b.TileMapLayerOrthogonal);b.TileMapObjectLayerOrthogonal=c}(c=b.Tilemap||(b.Tilemap={}))}(b=a.GameObjects||(a.GameObjects={}))}(Kiwi||(Kiwi={}));var Kiwi;!function(a){var b;!function(a){var b;!function(a){var b=function(){function a(){this._tileType=0}return Object.defineProperty(a.prototype,"tileType",{get:function(){return this._tileType},enumerable:!0,configurable:!0}),a}();a.TileObject=b}(b=a.Tilemap||(a.Tilemap={}))}(b=a.GameObjects||(a.GameObjects={}))}(Kiwi||(Kiwi={}));var Kiwi;!function(a){var b;!function(b){var c=function(){function c(a,b,c,d,e,f){void 0===a&&(a=1),void 0===b&&(b=0),void 0===c&&(c=0),void 0===d&&(d=1),void 0===e&&(e=0),void 0===f&&(f=0),this.a=1,this.b=0,this.c=0,this.d=1,this.tx=0,this.ty=0,this.setTo(a,b,c,d,e,f)}return c.prototype.objType=function(){return"MatrixOp"},Object.defineProperty(c.prototype,"xy",{get:function(){return new b.Point(this.tx,this.ty)},set:function(a){this.tx=a.x,this.ty=a.y},enumerable:!0,configurable:!0}),c.prototype.setTo=function(a,b,c,d,e,f){return void 0===a&&(a=1),void 0===b&&(b=0),void 0===c&&(c=0),void 0===d&&(d=1),void 0===e&&(e=0),void 0===f&&(f=0),this.a=a,this.b=b,this.c=c,this.d=d,this.tx=e,this.ty=f,this},c.prototype.setToMatrix=function(a){return this.a=a.a,this.b=a.b,this.c=a.c,this.d=a.d,this.tx=a.tx,this.ty=a.ty,this},c.prototype.setFromOffsetTransform=function(b,d,e,f,g,h,i){void 0===h&&(h=new a.Geom.Point(0,0)),void 0===i&&(i=new a.Geom.Point(0,0)),this.setIdentity();var j=Math.cos(g),k=Math.sin(g);return this.multiplyMatrix(new c(e,0,0,f,-i.x*e+i.x,i.y*f+i.y)),this.multiplyMatrix(new c(j,k,-k,j,-h.x*j+-h.y*k+h.x,-h.x*-k+-h.y*j+h.y)),this},c.prototype.multiplyMatrix=function(a){var b=new c;return b.a=this.a*a.a+this.b*a.c,b.b=this.a*a.b+this.b*a.d,b.c=this.c*a.a+this.d*a.c,b.d=this.c*a.b+this.d*a.d,b.tx=this.a*a.tx+this.b*a.ty+this.tx,b.ty=this.c*a.tx+this.d*a.ty+this.ty,b},c.identity=function(){return new c},c.prototype.setIdentity=function(){return this.a=1,this.b=0,this.c=0,this.d=1,this.tx=0,this.ty=0,this},c.prototype.rotate=function(a){var b=Math.cos(a),c=Math.sin(a),d=this.a,e=this.c,f=this.tx;return this.a=d*b-this.b*c,this.b=d*c+this.b*b,this.c=e*b-this.d*c,this.d=e*c+this.d*b,this.tx=f*b-this.ty*c,this.ty=f*c+this.ty*b,this},c.prototype.translate=function(a,b){return this.tx+=a,this.ty+=b,this},c.prototype.scale=function(a,b){return this.a*=a,this.d*=b,this},c.prototype.transformPoint=function(a){return new b.Point(this.a*a.x+this.c*a.y+this.tx,this.b*a.x+this.d*a.y+this.ty)},c.prototype.invert=function(){var a=this.a,b=this.b,c=this.c,d=this.d,e=this.tx,f=a*d-b*c;return this.a=d/f,this.b=-b/f,this.c=-c/f,this.d=a/f,this.tx=(c*this.ty-d*e)/f,this.ty=-(a*this.ty-b*e)/f,this},c.prototype.invertCopy=function(){var a=this.a*this.d-this.b*this.c;return new c(this.a=this.d/a,this.b=-this.b/a,this.c=-this.c/a,this.d=this.a/a,this.tx=(this.c*this.ty-this.d*this.tx)/a,this.ty=-(this.a*this.ty-this.b*this.tx)/a)},c.prototype.setMatrixOp=function(a){return this.a=a.a,this.b=a.b,this.c=a.c,this.d=a.d,this.tx=a.tx,this.ty=a.ty,this},c.prototype.clone=function(){return new a.Geom.MatrixOp(this.a,this.b,this.c,this.d,this.tx,this.ty)},Object.defineProperty(c.prototype,"toString",{get:function(){return"[{MatrixOp (a="+this.a+" b="+this.b+" c="+this.c+" d="+this.d+" tx="+this.tx+" ty="+this.ty+")}]"},enumerable:!0,configurable:!0}),c.prototype.equals=function(a){return this.a===a.a&&this.b===a.b&&this.c===a.c&&this.d===a.d&&this.tx===a.tx&&this.ty===a.ty},c}();b.MatrixOp=c}(b=a.Geom||(a.Geom={}))}(Kiwi||(Kiwi={}));var Kiwi;!function(a){var b;!function(a){var b=function(){function b(){this._origin=new a.Point(0,0),this._rotationPoint=new a.Point(0,0),this._scale=new a.Point(1,1),this._xy=new a.Point(0,0),this._rotation=0,this._parent=null,this._dirty=!0,this.loopAirbag=0,this.setTransform(0,0,1,1,0,0,0),this._matrix=new a.MatrixOp,this._cachedConcatenatedMatrix=new a.MatrixOp}return b.prototype.objType=function(){return"Transform2o"},Object.defineProperty(b.prototype,"xy",{get:function(){return this._xy},set:function(a){this._xy=a,this._dirty=!0},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"x",{get:function(){return this._xy.x},set:function(a){this._xy.x=a,this._performTranslate(this.xy),this._dirty=!0},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"y",{get:function(){return this._xy.y},set:function(a){this._xy.y=a,this._performTranslate(this.xy),this._dirty=!0},enumerable:!0,configurable:!0}),b.prototype._performTranslate=function(b){this._matrix=this._matrix.multiplyMatrix(new a.MatrixOp(1,0,0,1,b.x,b.y)),this._dirty=!0},Object.defineProperty(b.prototype,"scale",{get:function(){return this._scale},set:function(a){a.x?this._scale.xy=a:(this._scale.x=a,this._scale.y=a),this._performScale(this._scale),this._dirty=!0},enumerable:!0,configurable:!0}),b.prototype._performScale=function(b,c){void 0===c&&(c=this._origin),this._matrix=this._matrix.multiplyMatrix(new a.MatrixOp(b.x,0,0,b.y,-c.x*b.x+c.x,-c.y*b.y+c.y)),this._dirty=!0},Object.defineProperty(b.prototype,"rotation",{get:function(){return this._rotation},set:function(a){this._rotation=a,this._performRotation(a),this._dirty=!0},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"rotationPoint",{get:function(){return this._rotationPoint},set:function(a){this._rotationPoint=a},enumerable:!0,configurable:!0}),b.prototype._performRotation=function(b,c){void 0===c&&(c=this._rotationPoint);var d=Math.cos(b),e=Math.sin(b);this._matrix=this._matrix.multiplyMatrix(new a.MatrixOp(d,e,-e,d,-c.x*d+-c.y*e+c.x,-c.x*-e+-c.y*d+c.y)),this._dirty=!0},Object.defineProperty(b.prototype,"origin",{get:function(){return this._origin},set:function(a){this._origin=a},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"originX",{get:function(){return this._origin.x},set:function(a){this._origin.x=a},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"originY",{get:function(){return this._origin.y},set:function(a){this._origin.y=a},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"matrix",{get:function(){return this._matrix},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"parent",{get:function(){return this._parent},set:function(a){this.checkAncestor(a)||(this._parent=a,this._dirty=!0)},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"dirty",{get:function(){if(this.loopAirbag++>10)throw"Airbag deployed";var a=this._dirty&&this._parent?this._parent.dirty:!1;return this.loopAirbag=0,a},enumerable:!0,configurable:!0}),b.prototype.translate=function(a){return this._xy.x+=a.x,this._xy.y+=a.y,this._dirty=!0,this},b.prototype.setTransform=function(a,b,c,d,e,f,g){return void 0===a&&(a=0),void 0===b&&(b=0),void 0===c&&(c=1),void 0===d&&(d=1),void 0===e&&(e=0),void 0===f&&(f=0),void 0===g&&(g=0),this._xy.x=a,this._xy.y=b,this._scale.x=c,this._scale.y=d,this._rotation=e,this._origin.x=f,this._origin.y=g,this._dirty=!0,this},b.prototype.getParentMatrixOp=function(){return this._parent?this._parent.getConcatenatedMatrix():null},b.prototype.getConcatenatedMatrix=function(){return this.dirty&&(this._cachedConcatenatedMatrix.setToMatrix(this._matrix),this._parent&&this._parent.dirty&&(this._cachedConcatenatedMatrix=this._parent.getConcatenatedMatrix().multiplyMatrix(this._cachedConcatenatedMatrix)),this._dirty=!1),this._cachedConcatenatedMatrix},b.prototype.transformPoint=function(a){var b=this.getConcatenatedMatrix();return b.transformPoint(a)},b.prototype.checkAncestor=function(a){return!1},Object.defineProperty(b.prototype,"toString",{get:function(){return"[{Transform (x="+this._xy.x+" y="+this._xy.y+" scale= { "+this._scale.x+", "+this._scale.y+" } rotation="+this._rotation+" origin= { "+this._origin.x+", "+this.origin.y+" } MatrixOp="+this._matrix+")}]"},enumerable:!0,configurable:!0}),b}();a.Transform2o=b}(b=a.Geom||(a.Geom={}))}(Kiwi||(Kiwi={}));var Kiwi;!function(a){var b;!function(b){var c=function(){function b(a,b,c){void 0===a&&(a=0),void 0===b&&(b=0),void 0===c&&(c=0),this._x=a,this._y=b,this._z=c}return b.prototype.objType=function(){return"Vector3"},Object.defineProperty(b.prototype,"x",{get:function(){return this._x},set:function(a){this._x="number"==typeof a?a:a.x},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"y",{get:function(){return this._y},set:function(a){this._y="number"==typeof a?a:a.y},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"z",{get:function(){return this._z},set:function(a){this._z="number"==typeof a?a:a.z},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"xy",{get:function(){return{x:this._x,y:this._y}},set:function(a){"number"==typeof a?(this._x=a,this._y=a):(this._x=a.x,this._y=a.y)},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"yz",{get:function(){return{y:this._y,z:this._z}},set:function(a){"number"==typeof a?(this._y=a,this._z=a):(this._y=a.y,this._z=a.z)},enumerable:!0,configurable:!0}),Object.defineProperty(b.prototype,"xyz",{get:function(){return{x:this._x,y:this._y,z:this._z}},set:function(a){"number"==typeof a?(this._x=a,this._y=a,this._z=a):(this._x=a.x,this._y=a.y,this._z=a.z)},enumerable:!0,configurable:!0}),b.fromAngle=function(a){return new b(Math.cos(a),Math.sin(a),1)},b.randomRadius=function(a){return new b(2*Math.random()-1,2*Math.random()-1,2*Math.random()-1).multiplyScalar(a)},b.prototype.add=function(a){return new b(this.x+a.x,this.y+a.y,this.z+a.z)},b.prototype.addX=function(a){return new b(this.x+a.x,this.y,this.z)},b.prototype.addY=function(a){return new b(this.x,this.y+a.y,this.z)},b.prototype.addZ=function(a){return new b(this.x,this.y,this.z+a.z)},b.prototype.subtract=function(b){return new a.Geom.Vector3(this.x-b.x,this.y-b.y,this.z-b.z)},b.prototype.multiply=function(b){return new a.Geom.Vector3(this.x*b.x,this.y*b.y,this.z*b.z)},b.prototype.multiplyScalar=function(b){return new a.Geom.Vector3(this.x*b,this.y*b,this.z*b)},b.prototype.dot=function(a){return this.x*a.x+this.y*a.y+this.z*a.z},b.prototype.lenSqr=function(){return this.x*this.x+this.y*this.y+this.z*this.z},b.prototype.len=function(){return Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z)},b.prototype.unit=function(){var a=1/this.len();return this.multiplyScalar(a)},b.prototype.floor=function(){return new b(Math.floor(this.x),Math.floor(this.y),Math.floor(this.z))},b.prototype.ceil=function(){return new b(Math.ceil(this.x),Math.ceil(this.y),Math.ceil(this.z))},b.prototype.round=function(){return new b(Math.round(this.x),Math.round(this.y),Math.round(this.z))},b.prototype.clamp=function(a,c){return new b(Math.max(Math.min(this.x,c.x),a.x),Math.max(Math.min(this.y,c.y),a.y),Math.max(Math.min(this.z,c.z),a.z))},b.prototype.perp=function(){throw"Not implemented"},b.prototype.neg=function(){return new b(-this.x,-this.y,-this.z)},b.prototype.equal=function(a){return this.x===a.x&&this.y===a.y&&this.z===a.z},b.prototype.clear=function(){return this.x=0,this.y=0,this.z=0,this},b.prototype.clone=function(){return new b(this.x,this.y,this.z)},b.prototype.toString=function(){return"[{Vector3 (x="+this.x+" y="+this.y+" z="+this.z+")}]"},b}();b.Vector3=c}(b=a.Geom||(a.Geom={}))}(Kiwi||(Kiwi={}));